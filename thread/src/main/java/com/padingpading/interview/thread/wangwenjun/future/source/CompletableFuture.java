...
//            //设置stack属性,为栈顶元素的next。
//            if (f.casStack(h, t = h.next)) {
//                //栈顶元素的下一个
//                if (t != null) {
//                    //当前执行的CompletableFuture
//                    if (f != this) {
//                        //执行栈顶元素。
//                        pushStack(h);
//                        continue;
...
//        //Completion 依赖的要执行的CompletableFuture
//        CompletableFuture<V> dep;          // the dependent to complete
//        //依赖结果的CompletableFuture
...
//        }
//        //触发任务,如果执行返回要执行的CompletableFuture
//        final CompletableFuture<V> tryFire(int mode) {
//            CompletableFuture<V> d; CompletableFuture<T> a;
//            //依赖的CompletableFuture为空或者
//            if ((d = dep) == null ||
//                    //执行当前function。
