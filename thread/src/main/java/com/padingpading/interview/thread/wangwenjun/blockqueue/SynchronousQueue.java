...
// * BlockingQueue:阻塞队列。
// * 特点:
// * 1、队列不存储数据，所以没有大小，也无法迭代,容量为0
// * 2、阻塞队列,发送或者消费线程会阻塞，只有有一对消费和发送线程匹配上，才同时退出。
// * 3、配对有公平模式和非公平模式(默认)
// */
...
//         * e != null，相当于将一个数据交给消费者，如果
//         * e == null，则相当于从一个生产者接收一个消费者交出的数据。
//         * @param e  元素
...
//    }
//
//    /**基于Nonblocking Concurrent Objects with Condition Synchronization算法的Transferer的非公平模式的实现
//     * ，使用LIFO顺序存取元素，简称为Dual Stack，直译就是双重栈！
...
//    }
//
//    /**基于Nonblocking Concurrent Objects with Condition Synchronization算法的Transferer的公平模式的实现，
//     * 使用FIFO顺序存取元素，简称为Dual Queue，直译就是双重队列！
